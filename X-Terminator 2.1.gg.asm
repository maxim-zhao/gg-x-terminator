...
Text_TitleInstructions:
  Text " [ 1 2 ] SEL. DIGIT ", " [ 1 2 ] スウシ゛センタク   ", LINE_BREAK
  Text " [ 🡐 🡒 ] SEL. DIR   ", " [ 🡐 🡒 ] ミキ゛ヒタ゛リ    ", LINE_BREAK
  Text " [ 🡑 🡓 ] SEL. ITEM  ", " [ 🡑 🡓 ] ウエシタ       ", LINE_BREAK
  Text " [START] TO ACTION  ", " [START] ケッテイ       ", EOS

Text_MainMenu:
  Text " ----MAIN  MENU---- ", " -----メイン メニュー----- ", EOS
  Text "  AUTO CODE SCANER  ", "  ウラワサ゛ テ゛ータ サーチ    ", LINE_BREAK
  Text "  ENTER CODES       ", "  ウラワサ゛ テ゛ータ 入力     ", EOS
...
Text_EnterCodes:
  Text " ---ENTER  CODES--- ", " ----ウラワサ゛ テ゛ータ---- ", EOS
  ...
  Text "  CODE 3: 00000000  ", "  CODE 3: 00000000  ", LINE_BREAK
  Text "  CODE 4: 00000000  ", "  CODE 4: 00000000  ", LINE_BREAK
  Text "  CODE 5: 00000000  ", "  CODE 5: 00000000  ", EOS
...
Text_ScannerType:
  Text " ---SCANER  TYPE--- ", " --ウラワサ゛ テ゛ータ サーチ-- ", EOS
  Text "  LIVES OR NO. < 99 ", "  ニンス゛ウ・キスウ < 99    ", LINE_BREAK
  Text "  TIMER OR NO. > 99 ", "  シ゛カン・タイマー > 99    ", LINE_BREAK
  Text "  ENERGY BAR        ", "  エネルキ゛ー ケ゛ーシ゛      ", LINE_BREAK
  Text "  POWER BAR         ", "  ハ゛ランス  ケ゛ーシ゛      ", LINE_BREAK
  Text "  STATUS            ", "  ハ゜ワー   テ゛ータ       ", LINE_BREAK
  Text "  OTHER POSSIBILTY  ", "  スヘ゜シャル テ゛ータ       ", LINE_BREAK
  Text "  QUIT TO MAIN MENU ", "  メインメニュー ニ モト゛ル    ", EOS
...
Text_LivesScanner:
  Text " ---LIVES SCANER--- ", " --ニンス゛ウ・キスウ  サーチ-- ", EOS
  ...
  Text "THE NUMBER OF LIVES ", "ケ゛ンサ゛イ ノ ニンス゛ウ・キスウ ヲ", LINE_BREAK
  Text "OR ETC              ", "入力して下さい             ", EOS
...
Text_LivesScannerUpdate:
  ...
  Text "FOR THE NUMBER OF   ", "アタラシイ ニンス゛ウ・キスウ ヲ   ", LINE_BREAK
  Text "LIVES OR ETC        ", "入力して下さい             ", EOS
...
Text_TimerScanner:
  Text " ---TIMER SCANER--- ", " --シ゛カン・タイマー  サーチ-- ", EOS
  Text "  CURRENT START     ", "  スタート ノ アタイ セッテイ   ", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  メインメニュー ニ モト゛ル    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "USE THIS METHOD FOR ", "                    ", LINE_BREAK
  Text "SEARCH VALUE LIKE   ", "シ゛カン・タイマー ノ テ゛ータ サーチ", LINE_BREAK
  Text "TIMER OR NO. > 99   ", "ヲ オコナイマス > 99       ", EOS
...
Text_TimerScannerUpdate:
  ...
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "スタートノ アタイト ケ゛ンサ゛イノ  ", LINE_BREAK
  Text "ENTER DIFFERENCE    ", "アタイノ サヲ 入力して下さい     ", LINE_BREAK
  Text "BETWEEN START VALUE ", "モシ スタートカ゛100テ゛ ケ゛ンサ゛", LINE_BREAK
  Text "AND CURRENT VALUE   ", "イカ゛96ナラ ー4ト 入力して下さい ", EOS
...
Text_EnergyScanner:
  Text " --ENERGY  SCANER-- ", " ----エネルキ゛ー サーチ---- ", EOS
  Text "  CURRENT START     ", "  テ゛ータ サーチ スタート     ", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  メインメニュー ニ モト゛ル    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "コノ エネルキ゛ーテ゛ータ サーチ   ", LINE_BREAK
  Text "USE THIS METHOD FOR ", "モート゛ ハ エネルキ゛ー カ゛    ", LINE_BREAK
  Text "ENERGY BAR SHOULD   ", "ショキチ ノ トキニ サーチ ヲ    ", LINE_BREAK
  Text "START IN FULL POWER ", "スタート シマス            ", EOS
...
Text_EnergyScannerUpdate:
  Text "  SAME AS START     ", "  スタート ト オナシ゛クライ    ", LINE_BREAK
  Text "  ABOUT 75% OF START", "  スタート ノ ヤク 75%     ", LINE_BREAK
  Text "  ABOUT 50% OF START", "  スタート ノ ヤク 50%     ", LINE_BREAK
  Text "  ABOUT 25% OF START", "  スタート ノ ヤク 25%     ", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  チュウシ・メインメニュー      ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "CHOOSE PERCENTAGE   ", "                    ", LINE_BREAK
  Text "BETWEEN START VALUE ", "スタート ト ケ゛ンサ゛イ ノ アタイ ", LINE_BREAK
  Text "AND CURRENT VALUE   ", "ノ サヲ エランテ゛下さい       ", EOS
...
Text_PowerScanner:
  Text " ---POWER SCANER--- ", " ---ハ゛ランス  ケ゛ーシ゛--- ", EOS
  Text "  CURRENT START     ", "  スタート ノ シ゛ョウタイセッテイ ", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  メインメニュー ニ モト゛ル    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "コノ モート゛ ハ スタート ノ    ", LINE_BREAK
  Text "                    ", "シ゛ョウタイ カラ ソ゛ウケ゛ンスル  ", LINE_BREAK
  Text "USE THIS METHOD FOR ", "ハ゛ーシ゛ョウ ノ テ゛ータ ヲ    ", LINE_BREAK
  Text "POWER BAR OR ETC    ", "サーチ シマス             ", EOS
...
Text_PowerScannerUpdate:
  Text "  SAME AS START     ", "  スタート ト オナシ゛シ゛ョウタイ ", LINE_BREAK
  Text "  GREATER THAN START", "  スタート ヨリ フエテイル     ", LINE_BREAK
  Text "  SMALLER THAN START", "  スタート ヨリ ヘッテイル     ", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  メインメニュー ニ モト゛ル    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "CHOOSE DIFFERENCE   ", "スタート ノ シ゛ョウタイ ト     ", LINE_BREAK
  Text "BETWEEN START VALUE ", "ケ゛ンサ゛イ ノ シ゛ョウタイ ノ   ", LINE_BREAK
  Text "AND CURRENT VALUE   ", "チカ゛イヲ エランテ゛下さい      ", EOS
...
Text_StatusScanner:
  Text " --STATUS  SCANER-- ", " ---ハ゜ワーテ゛ータ サーチ--- ", EOS
  Text "  CURRENT START     ", "  テ゛ータ サーチ スタート     ", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  メインメニュー ニ モト゛ル    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  ...
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "USE THIS METHOD FOR ", "ハ゜ワーテ゛ータ サーチ モート゛ ヲ ", LINE_BREAK
  Text "OPTION OR WEAPON ETC", "スタート シマス            ", EOS
...
Text_StatusScannerUpdate:
  Text "  SAME AS START     ", "  スタート ト オナシ゛ ステータス ", LINE_BREAK
  Text "  OPPOSITE TO START ", "  スタート ト ハンタイノ ステータス", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  チュウシ・メインメニュー      ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "CHOOSE DIFFERENCE   ", "                    ", LINE_BREAK
  Text "BETWEEN START STATUS", "スタート ト ケ゛ンサ゛イ ノ アタイ ", LINE_BREAK
  Text "AND CURRENT STATUS  ", "ノ チカ゛イヲ エランテ゛下さい    ", EOS
...
Text_OtherPossibility:
  Text " OTHER  POSSIBILITY ", " --スヘ゜シャルサーチ モート゛-- ", EOS
  Text "  CURRENT START     ", "  サーチ スタート          ", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  メインメニュー ニ モト゛ル    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  ...
  Text "ALL OTHER METHOD    ", "テ゛ータエリア ノ スヘ゛テ ヲ    ", LINE_BREAK
  Text "FAILED              ", "サーチ シマス             ", EOS
...
Text_OtherPossibilityUpdate:
  Text "  SAME AS START     ", "  スタート ト オナシ゛       ", LINE_BREAK
  Text "  DIFFERENT TO START", "  スタート ト チカ゛ウ       ", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  チュウシ・メインメニュー      ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "CHOOSE DIFFERENCE   ", "                    ", LINE_BREAK
  Text "BETWEEN START STATUS", "スタート ト ケ゛ンサ゛イ ノ     ", LINE_BREAK
  Text "AND CURRENT STATUS  ", "シ゛ョウタイヲ エランテ゛下さい    ", EOS
...
Text_ScannerMenu:
  Text " ---SCANER  MENU--- ", " ---テ゛ータサーチ メニュー--- ", EOS
  Text "  CONTINUE SCANER   ", "  ウラワサ゛ テ゛ータ サーチ    ", LINE_BREAK
  Text "  ENTER CODES       ", "  ウラワサ゛ テ゛ータ 入力     ", LINE_BREAK
  Text "  CLEAR MEMORY      ", "  テ゛ータ クリア・チュウシ     ", LINE_BREAK
  Text "  POSSIBLE CODES    ", "  ウラワサ゛ テ゛ータ ヒョウシ゛  ", EOS
...
Text_ParametersList:
  Text " -PARAMETERS  LIST- ", " --ウラワサ゛ テ゛ータ リスト-- ", EOS
...
Text_NothingValid:
  ...
  Text "  VAILD NOW         ", "テ゛ータ カ゛ ミツカリマセン     ", EOS
...
Text_ForOtherPossibilities:
  ...
  Text "  AUTO CODE SCANNER ", "ホカノホウホウ ヲ エランテ゛下さい。 ", EOS

Text_PleaseContinue:
  Text "  PLEASE CONTINUE   ", LINE_BREAK
  Text "  THE SCANNER       ", "テ゛ータサーチ ヲ ツツ゛ケテ下さい。 ", EOS

Text_SearchMemory:
  Text "    SEARCH MEMORY   ","   テ゛ータ サーチ シテイマス   ", LINE_BREAK
  Text "     PLEASE WAIT    ","     チョット マッテ !     ", EOS

Text_SwitchToScannerMode: ; Unused?
  Text "   TURN SWITCH TO   ", "スイッチ ヲ スキャナー モート゛ヘ  ", LINE_BREAK
  Text "    SCANER  MODE    ", "カエテ下さい。             ", EOS
