...
Text_TitleInstructions:
  Text " [ 1 2 ] SEL. DIGIT ", " [ 1 2 ] ½³¼Þ¾ÝÀ¸   ", LINE_BREAK
  Text " [ ( ) ] SEL. DIR   ", " [ ( ) ] Ð·ÞËÀÞØ    ", LINE_BREAK
  Text " [ ^ _ ] SEL. ITEM  ", " [ ^ _ ] ³´¼À       ", LINE_BREAK
  Text " [START] TO ACTION  ", " [START] ¹¯Ã²       ", EOS

Text_MainMenu:
  Text " ----MAIN  MENU---- ", " -----Ò²Ý ÒÆ­°----- ", EOS
  Text "  AUTO CODE SCANER  ", "  ³×Ü»Þ ÃÞ°À »°Á    ", LINE_BREAK
  Text "  ENTER CODES       ", "  ³×Ü»Þ ÃÞ°À äã     ", EOS
...
Text_ScannerType:
  Text " ---SCANER  TYPE--- ", " --³×Ü»Þ ÃÞ°À »°Á-- ", EOS
  Text "  LIVES OR NO. < 99 ", "  ÆÝ½Þ³¥·½³ < 99    ", LINE_BREAK
  Text "  TIMER OR NO. > 99 ", "  ¼Þ¶Ý¥À²Ï° > 99    ", LINE_BREAK
  Text "  ENERGY BAR        ", "  ´ÈÙ·Þ° ¹Þ°¼Þ      ", LINE_BREAK
  Text "  POWER BAR         ", "  ÊÞ×Ý½  ¹Þ°¼Þ      ", LINE_BREAK
  Text "  STATUS            ", "  ÊßÜ°   ÃÞ°À       ", LINE_BREAK
  Text "  OTHER POSSIBILTY  ", "  ½Íß¼¬Ù ÃÞ°À       ", LINE_BREAK
  Text "  QUIT TO MAIN MENU ", "  Ò²ÝÒÆ­° Æ ÓÄÞÙ    ", EOS
...
Text_LivesScanner:
  ...
  Text "THE NUMBER OF LIVES ", "¹ÞÝ»Þ² É ÆÝ½Þ³¥·½³ ¦", LINE_BREAK
  Text "OR ETC              ", "äãàáâåç             ", EOS
...
Text_LivesScannerUpdate:
  ...
  Text "FOR THE NUMBER OF   ", "±À×¼² ÆÝ½Þ³¥·½³ ¦   ", LINE_BREAK
  Text "LIVES OR ETC        ", "äãàáâåç             ", EOS
...
Text_TimerScanner:
  Text " ---TIMER SCANER--- ", " --¼Þ¶Ý¥À²Ï°  »°Á-- ", EOS
  Text "  CURRENT START     ", "  ½À°Ä É ±À² ¾¯Ã²   ", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  Ò²ÝÒÆ­° Æ ÓÄÞÙ    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "USE THIS METHOD FOR ", "                    ", LINE_BREAK
  Text "SEARCH VALUE LIKE   ", "¼Þ¶Ý¥À²Ï° É ÃÞ°À »°Á", LINE_BREAK
  Text "TIMER OR NO. > 99   ", "¦ µºÅ²Ï½ > 99       ", EOS
...
Text_TimerScannerUpdate:
  ...
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "½À°ÄÉ ±À²Ä ¹ÞÝ»Þ²É  ", LINE_BREAK
  Text "ENTER DIFFERENCE    ", "±À²É »¦ äãàáâåç     ", LINE_BREAK
  Text "BETWEEN START VALUE ", "Ó¼ ½À°Ä¶Þ100ÃÞ ¹ÞÝ»Þ", LINE_BREAK
  Text "AND CURRENT VALUE   ", "²¶Þ96Å× °4Ä äãàáâåç ", EOS
...
Text_EnergyScanner:
  Text " --ENERGY  SCANER-- ", " ----´ÈÙ·Þ° »°Á---- ", EOS
  Text "  CURRENT START     ", "  ÃÞ°À »°Á ½À°Ä     ", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  Ò²ÝÒÆ­° Æ ÓÄÞÙ    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "ºÉ ´ÈÙ·Þ°ÃÞ°À »°Á   ", LINE_BREAK
  Text "USE THIS METHOD FOR ", "Ó°ÄÞ Ê ´ÈÙ·Þ° ¶Þ    ", LINE_BREAK
  Text "ENERGY BAR SHOULD   ", "¼®·Á É Ä·Æ »°Á ¦    ", LINE_BREAK
  Text "START IN FULL POWER ", "½À°Ä ¼Ï½            ", EOS
...
Text_EnergyScannerUpdate:
  Text "  SAME AS START     ", "  ½À°Ä Ä µÅ¼Þ¸×²    ", LINE_BREAK
  Text "  ABOUT 75% OF START", "  ½À°Ä É Ô¸ 75%     ", LINE_BREAK
  Text "  ABOUT 50% OF START", "  ½À°Ä É Ô¸ 50%     ", LINE_BREAK
  Text "  ABOUT 25% OF START", "  ½À°Ä É Ô¸ 25%     ", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  Á­³¼¥Ò²ÝÒÆ­°      ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "CHOOSE PERCENTAGE   ", "                    ", LINE_BREAK
  Text "BETWEEN START VALUE ", "½À°Ä Ä ¹ÞÝ»Þ² É ±À² ", LINE_BREAK
  Text "AND CURRENT VALUE   ", "É »¦ ´×ÝÃÞâåç       ", EOS
...
Text_PowerScanner:
  Text " ---POWER SCANER--- ", " ---ÊÞ×Ý½  ¹Þ°¼Þ--- ", EOS
  Text "  CURRENT START     ", "  ½À°Ä É ¼Þ®³À²¾¯Ã² ", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  Ò²ÝÒÆ­° Æ ÓÄÞÙ    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "ºÉ Ó°ÄÞ Ê ½À°Ä É    ", LINE_BREAK
  Text "                    ", "¼Þ®³À² ¶× ¿Þ³¹ÞÝ½Ù  ", LINE_BREAK
  Text "USE THIS METHOD FOR ", "ÊÞ°¼Þ®³ É ÃÞ°À ¦    ", LINE_BREAK
  Text "POWER BAR OR ETC    ", "»°Á ¼Ï½             ", EOS
...
Text_PowerScannerUpdate:
  Text "  SAME AS START     ", "  ½À°Ä Ä µÅ¼Þ¼Þ®³À² ", LINE_BREAK
  Text "  GREATER THAN START", "  ½À°Ä ÖØ Ì´Ã²Ù     ", LINE_BREAK
  Text "  SMALLER THAN START", "  ½À°Ä ÖØ Í¯Ã²Ù     ", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  Ò²ÝÒÆ­° Æ ÓÄÞÙ    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "CHOOSE DIFFERENCE   ", "½À°Ä É ¼Þ®³À² Ä     ", LINE_BREAK
  Text "BETWEEN START VALUE ", "¹ÞÝ»Þ² É ¼Þ®³À² É   ", LINE_BREAK
  Text "AND CURRENT VALUE   ", "Á¶Þ²¦ ´×ÝÃÞâåç      ", EOS
...
Text_StatusScanner:
  Text " --STATUS  SCANER-- ", " ---ÊßÜ°ÃÞ°À »°Á--- ", EOS
  Text "  CURRENT START     ", "  ÃÞ°À »°Á ½À°Ä     ", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  Ò²ÝÒÆ­° Æ ÓÄÞÙ    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  ...
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "USE THIS METHOD FOR ", "ÊßÜ°ÃÞ°À »°Á Ó°ÄÞ ¦ ", LINE_BREAK
  Text "OPTION OR WEAPON ETC", "½À°Ä ¼Ï½            ", EOS
...
Text_StatusScannerUpdate:
  Text "  SAME AS START     ", "  ½À°Ä Ä µÅ¼Þ ½Ã°À½ ", LINE_BREAK
  Text "  OPPOSITE TO START ", "  ½À°Ä Ä ÊÝÀ²É ½Ã°À½", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  Á­³¼¥Ò²ÝÒÆ­°      ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "CHOOSE DIFFERENCE   ", "                    ", LINE_BREAK
  Text "BETWEEN START STATUS", "½À°Ä Ä ¹ÞÝ»Þ² É ±À² ", LINE_BREAK
  Text "AND CURRENT STATUS  ", "É Á¶Þ²¦ ´×ÝÃÞâåç    ", EOS
...
Text_OtherPossibility:
  Text " OTHER  POSSIBILITY ", " --½Íß¼¬Ù»°Á Ó°ÄÞ-- ", EOS
  Text "  CURRENT START     ", "  »°Á ½À°Ä          ", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  Ò²ÝÒÆ­° Æ ÓÄÞÙ    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  ...
  Text "ALL OTHER METHOD    ", "ÃÞ°À´Ø± É ½ÍÞÃ ¦    ", LINE_BREAK
  Text "FAILED              ", "»°Á ¼Ï½             ", EOS
...
Text_OtherPossibilityUpdate:
  Text "  SAME AS START     ", "  ½À°Ä Ä µÅ¼Þ       ", LINE_BREAK
  Text "  DIFFERENT TO START", "  ½À°Ä Ä Á¶Þ³       ", LINE_BREAK
  Text "  QUIT TO SCAN MENU ", "  Á­³¼¥Ò²ÝÒÆ­°      ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "                    ", "                    ", LINE_BREAK
  Text "CHOOSE DIFFERENCE   ", "                    ", LINE_BREAK
  Text "BETWEEN START STATUS", "½À°Ä Ä ¹ÞÝ»Þ² É     ", LINE_BREAK
  Text "AND CURRENT STATUS  ", "¼Þ®³À²¦ ´×ÝÃÞâåç    ", EOS
...
Text_ScannerMenu:
  Text " ---SCANER  MENU--- ", " ---ÃÞ°À»°Á ÒÆ­°--- ", EOS
  Text "  CONTINUE SCANER   ", "  ³×Ü»Þ ÃÞ°À »°Á    ", LINE_BREAK
  Text "  ENTER CODES       ", "  ³×Ü»Þ ÃÞ°À äã     ", LINE_BREAK
  Text "  CLEAR MEMORY      ", "  ÃÞ°À ¸Ø±¥Á­³¼     ", LINE_BREAK
  Text "  POSSIBLE CODES    ", "  ³×Ü»Þ ÃÞ°À Ë®³¼Þ  ", EOS
...
Text_ParametersList:
  Text " -PARAMETERS  LIST- ", " --³×Ü»Þ ÃÞ°À Ø½Ä-- ", EOS
...
.asc "  THE SCANNER       ", EOS
.else
.asc "ÃÞ°À»°Á ¦ ÂÂÞ¹Ãâåç¡ ", EOS
.endif

Text_SearchMemory:
  Text "    SEARCH MEMORY   ","   ÃÞ°À »°Á ¼Ã²Ï½   ", LINE_BREAK
  Text "     PLEASE WAIT    ","     Á®¯Ä Ï¯Ã !     ", EOS

Text_SwitchToScannerMode: ; Unused?
  Text "   TURN SWITCH TO   ", "½²¯Á ¦ ½·¬Å° Ó°ÄÞÍ  ", LINE_BREAK
  Text "    SCANER  MODE    ", "¶´Ãâåç¡             ", EOS
